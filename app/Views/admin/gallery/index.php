...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
        <h1 class="text-2xl font-bold text-gray-800"><?= esc($catInfo['label']) ?></h1>
        <p class="text-gray-400 text-sm mt-1">Kelola foto dan video untuk halaman <?= esc($catInfo['label']) ?>.</p>
    </div>
...
<div class="bg-white rounded-2xl border-2 border-dashed border-gray-200 p-16 text-center">
    ...
    <p class="text-gray-400 font-medium">Belum ada item. Mulai tambahkan foto atau video!</p>
