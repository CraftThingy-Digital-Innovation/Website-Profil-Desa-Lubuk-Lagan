...
<body class="font-sans antialiased text-gray-800 flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="w-64 bg-sidebar text-white flex flex-col flex-shrink-0 overflow-y-auto z-50 shadow-2xl">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1">
            ...
            <a href="<?= base_url('admin/kkn') ?>" onclick="closeSidebar()" class="nav-item <?= str_contains(current_url(), 'admin/kkn') ? 'active' : '' ?> flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-300 hover:text-white">
            ...
            <a href="<?= base_url('admin/history') ?>" onclick="closeSidebar()" class="nav-item <?= str_contains(current_url(), 'admin/history') ? 'active' : '' ?> flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-300 hover:text-white">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                <span class="font-medium text-sm">Sejarah & Profil</span>
            </a>
